...
export default function RealEstateOS() {
  const solutions = [
    { title: "Zero-Second Response", promise: "Every lead gets an instant reply, even at midnight.", desc: "Buyer enquiries receive an immediate, personalized response the moment they come in. No lead waits. No lead is forgotten. Your agents pick up warm conversations, not cold callbacks." },
    { title: "Owner Lead Engine", promise: "Find new listing opportunities in your zone before anyone else.", desc: "New owners entering the market in your area are identified and flagged automatically. Your team contacts them first, before three competitors have already called." },
    { title: "The Owner Reactivator", promise: "Turn past owners into future listings.", desc: "Owners you\u2019ve worked with before receive ongoing attention: market updates, valuation changes, personalized touchpoints. When they\u2019re ready to list again, you\u2019re already top of mind." },
    { title: "5-Minute Contracts", promise: "Generate contracts and offers in minutes, not hours.", desc: "Property details, client information, and terms flow into professionally formatted documents automatically. What used to take an afternoon takes five minutes." },
    { title: "One-Click Viewings", promise: "Property viewings coordinate themselves.", desc: "Scheduling, confirmation, reminders, and feedback collection happen without your agents managing calendars and sending messages manually." },
    { title: "24/7 Reception", promise: "Your agency answers every call, day and night.", desc: "An AI-powered phone reception handles enquiries, qualifies callers, and routes opportunities to the right agent. No missed calls, no voicemails disappearing." },
    { title: "Agency Command Center", promise: "One dashboard to see everything that matters.", desc: "All your leads, owners, properties, deals, and agent activity in one view. No more switching between five tools to understand what\u2019s happening in your agency." },
  ];
  ...
  const faqs = [
    ...
    { q: "Will my agents need to learn new software?", a: "No. We build on your existing tools. Agents see improvements without changing how they work." },
    { q: "What if my agency is small (2\u20133 agents)?", a: "We have solutions designed for agencies of all sizes. Book a call and we\u2019ll recommend the right fit." },
    { q: "Do you work with our existing portal/CRM?", a: "We integrate with all major portals and CRMs used in the industry." },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="mt-6 text-lg leading-relaxed text-text-muted max-w-xl">
                We become your agency&apos;s AI operations team. Capture new owners before your
                competitors, respond to buyers in seconds, automate the paperwork. All deployed
                on your existing tools, managed by our team, and continuously improved. We train
                your people so your agency stays at the forefront.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <h3 className="font-display text-3xl sm:text-4xl font-bold text-charcoal leading-tight mb-6">
              New listings are going to your competitors. And your team doesn&apos;t even know it.
            </h3>
            <p className="text-text-muted text-lg leading-relaxed mb-8">
              Private owners are listing properties every week in your zone. By the time your team
              spots them, three other agencies have already called. Meanwhile, your current owners
              aren&apos;t getting the attention they deserve. Your agents are too busy copying data
              between systems, filling out contracts by hand, and chasing leads on their phone.
              The result: lost listings, slow responses, and revenue walking out the door.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            {[
              {
                icon: Target,
                title: "Losing listings to faster competitors",
                desc: "New owners in your zone are being captured by agencies that move faster. Every day you don\u2019t know about a new listing is a day your competitor is already calling.",
              },
              {
                icon: Clock,
                title: "Leads going cold",
                desc: "A buyer enquiry comes in at 8pm. By the time your agent sees it the next morning, they\u2019ve already contacted three other agencies.",
              },
              {
                icon: FileText,
                title: "Agents buried in admin",
      ...
      <WhyWeDifferent
        industryExample="When we audit a real estate agency, we typically find 8-12 processes that can be automated, from lead response to owner reporting to contract generation. We don't sell you a CRM and walk away. We build the systems, train your agents, and optimize monthly."
      />
      ...
      <section className="py-24 px-6 bg-white border-y border-sand">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h3 className="font-display text-3xl sm:text-4xl font-bold text-charcoal leading-tight mb-6">
              Start with one win. Scale from there.
            </h3>
            ...
            <p className="text-text-muted text-sm mb-8 italic">
              If we can&apos;t find at least €2,000/month in savings or the first automation isn&apos;t live in 4 weeks, you don&apos;t pay.
            </p>
            <Link
              href="/book-a-call"
              className="inline-flex items-center justify-center px-8 py-3.5 font-medium tracking-tight text-white rounded-xl bg-charcoal text-base shadow-xl shadow-charcoal/10 hover:bg-black transition-all active:scale-95"
      ...
      <section className="py-24 px-6 bg-white border-y border-sand">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              "Typical agency audit identifies 8\u201312 automation opportunities",
      ...
      {/* ──────── T10: FINAL CTA ──────── */}
      <FinalCTA verticalPhrase="your agency" />
    </div>
  );
}
